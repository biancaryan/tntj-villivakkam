...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'newsnow-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'newsnow-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'newsnow-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'newsnow-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'newsnow-pro' ),
		'devanagari'   => __( 'Devanagari', 'newsnow-pro' ),
		'greek'        => __( 'Greek', 'newsnow-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'newsnow-pro' ),
		'khmer'        => __( 'Khmer', 'newsnow-pro' ),
		'latin'        => __( 'Latin', 'newsnow-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'newsnow-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'newsnow-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'newsnow-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'newsnow-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'newsnow-pro' ),
