...
<div id="post-<?php the_ID(); ?>" <?php post_class( $class ); ?>>	
	...
	<div class="entry-summary">
		<?php echo newsnow_pro_custom_excerpt( get_theme_mod('archive-excerpt-length','33') ); ?>
		<span><a href="<?php the_permalink(); ?>"><?php esc_html_e('Read more &raquo;', 'newsnow-pro'); ?></a></span>
	</div><!-- .entry-summary -->
