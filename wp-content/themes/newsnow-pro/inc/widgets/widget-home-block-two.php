 ...
 * @since      1.0.0
 */
class newsnow_pro_Block_Two_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newsnow_pro-home-two-columns',
			'description' => __( 'Display two-column post blocks. Only use for the "Homepage Content" widget area.', 'newsnow-pro' )
		);

		// Create the widget.
		parent::__construct(
			'happythemes-home-two-columns',         // $this->id_base
			__( '&raquo; Home Two Columns', 'newsnow-pro' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			echo '<div class="content-block content-block-2 clear">';
				...
				// Column first post
				newsnow_pro_home_posts_first( $args, $instance );

				// Column first post
				newsnow_pro_home_posts_second( $args, $instance );
 ...
 * Column first posts
 */
function newsnow_pro_home_posts_first( $args, $instance ) {
	...
	$query = apply_filters( 'newsnow_pro_home_two_columns_1_args', $args );
 ...
 * Column second posts
 */
function newsnow_pro_home_posts_second( $args, $instance ) {
	...
	// Allow dev to filter the post arguments.
	$query = apply_filters( 'newsnow_pro_home_two_columns_2_args', $args );
