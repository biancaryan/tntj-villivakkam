 ...
 * @since      1.0.0
 */
class newsnow_pro_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newsnow_pro-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'newsnow-pro' )
		);

		// Create the widget.
		parent::__construct(
			'newsnow_pro-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'newsnow-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow Us', 'newsnow-pro' ),
			'desc'       => esc_html__( 'Stay updated via social channels', 'newsnow-pro' ),		
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>">
				<?php _e( 'Description', 'newsnow-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus' ); ?>">
				<?php _e( 'Google Plus', 'newsnow-pro' ); ?>
			</label>
