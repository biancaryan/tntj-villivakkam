 ...
 * @since      1.0.0
 */
class newsnow_pro_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newsnow_pro-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'newsnow-pro' )
		);

		// Create the widget.
		parent::__construct(
			'newsnow_pro-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'newsnow-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'newsnow-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
