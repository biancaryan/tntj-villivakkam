 ...
 * @since      1.0.0
 */
class newsnow_pro_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newsnow_pro-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'newsnow-pro' )
		);

		// Create the widget.
		parent::__construct(
			'newsnow_pro-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'newsnow-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'newsnow-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
