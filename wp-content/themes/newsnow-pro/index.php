	...
	<div id="primary" class="content-area clear">
		...
		?>
			...
			<div id="latest-content">
				<h3><?php esc_html_e('Latest News', 'newsnow-pro'); ?></h3>
					...
					<div class="more-button">
						<a class="btn" href="<?php echo get_theme_mod('all-posts-url', home_url() . '/latest/'); ?>"><?php esc_html_e('View More News', 'newsnow-pro'); ?></a>
					</div>
